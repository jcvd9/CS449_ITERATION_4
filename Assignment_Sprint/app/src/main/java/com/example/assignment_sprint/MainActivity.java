...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewPlayer1 = findViewById(R.id.text_view_play_1);
        textViewPlayer2 = findViewById(R.id.text_view_play_2);

        /*
        This for loop is indicated our row and column
         */
        for (int i = 0; i < 3; i++) {
            ...
            for (int j = 0; j < 3; j++) {
                ...
                int reID = getResources().getIdentifier(buttonID, "id", getPackageName());
                buttons[i][j] = findViewById(reID);
